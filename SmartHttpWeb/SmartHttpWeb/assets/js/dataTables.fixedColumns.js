...
FixedColumns.prototype = /** @lends FixedColumns.prototype */{
	...
	"_fnGridSetup": function ()
	{
		...
		var nSWrapper =
			$('<div class="DTFC_ScrollWrapper" style="position:relative; clear:both;">'+
				'<div class="DTFC_LeftWrapper" style="position:absolute; top:0; left:0;">'+
					...
					'<div class="DTFC_LeftBodyWrapper" style="position:relative; top:0; left:0; overflow:inherit;">' +
						'<div class="DTFC_LeftBodyLiner" style="position:relative; top:0; left:0; overflow-y:inherit;"></div>' +
					'</div>'+
				...
				'<div class="DTFC_RightWrapper" style="position:absolute; top:0; left:0;">'+
					...
					'</div>'+
					'<div class="DTFC_RightBodyWrapper" style="position:relative; top:0; left:0; overflow:inherit;">' +
						'<div class="DTFC_RightBodyLiner" style="position:relative; top:0; left:0; overflow-y:inherit;"></div>' +
					'</div>'+
		...
		if ( this.s.iRightColumns > 0 )
		{
			...
			block.style.width = oOverflow.bar+"px";//2015
	...
	"_fnGridLayout": function ()
	{
		...
		var scrollbarAdjust = function ( node, width ) {
			if ( ! oOverflow.bar ) {
			    ...
			    node.style.width = width + "px";//2015
			}
		};
